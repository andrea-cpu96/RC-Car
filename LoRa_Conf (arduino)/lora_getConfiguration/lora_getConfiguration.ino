...
void printParameters(struct Configuration configuration) {
	...
	Serial.print(F("HEAD : "));  Serial.print(configuration.COMMAND, DEC);Serial.print(" ");Serial.print(configuration.STARTING_ADDRESS, DEC);Serial.print(" ");Serial.println(configuration.LENGHT, DEC);
	Serial.println(F(" "));
